...
import { colorsBatch1, titlesBatch1 } from '../../deploy/helpers'
...
export default async function deployFieldGenerator(asGasSnapshot?: boolean) {
	...
	const fieldSVGs10 = (await (
		await ethers.getContractFactory('FieldSVGs10')
	).deploy()) as FieldSVGs1
	const fieldSVGs11 = (await (
		await ethers.getContractFactory('FieldSVGs11')
	).deploy()) as FieldSVGs1
	const fieldSVGs12 = (await (
		await ethers.getContractFactory('FieldSVGs12')
	).deploy()) as FieldSVGs1
	const fieldSVGs13 = (await (
		await ethers.getContractFactory('FieldSVGs13')
	).deploy()) as FieldSVGs1
	const fieldSVGs14 = (await (
		await ethers.getContractFactory('FieldSVGs14')
	).deploy()) as FieldSVGs1
	const fieldSVGs15 = (await (
		await ethers.getContractFactory('FieldSVGs15')
	).deploy()) as FieldSVGs1
	const fieldSVGs16 = (await (
		await ethers.getContractFactory('FieldSVGs16')
	).deploy()) as FieldSVGs1
	const fieldSVGs17 = (await (
		await ethers.getContractFactory('FieldSVGs17')
	).deploy()) as FieldSVGs1
	const fieldSVGs18 = (await (
		await ethers.getContractFactory('FieldSVGs18')
	).deploy()) as FieldSVGs1
	const fieldSVGs19 = (await (
		await ethers.getContractFactory('FieldSVGs19')
	).deploy()) as FieldSVGs1
	const fieldSVGs20 = (await (
		await ethers.getContractFactory('FieldSVGs20')
	).deploy()) as FieldSVGs1
	const fieldSVGs21 = (await (
		await ethers.getContractFactory('FieldSVGs21')
	).deploy()) as FieldSVGs1
	const fieldSVGs22 = (await (
		await ethers.getContractFactory('FieldSVGs22')
	).deploy()) as FieldSVGs1
	const fieldSVGs23 = (await (
		await ethers.getContractFactory('FieldSVGs23')
	).deploy()) as FieldSVGs1
	const fieldSVGs24 = (await (
		await ethers.getContractFactory('FieldSVGs24')
	).deploy()) as FieldSVGs1
	...
	if (asGasSnapshot) {
		await snapshotGasCost(
			(await ethers.getContractFactory('FieldGenerator')).deploy(fieldColors, titles, svgs)
		)
	}
