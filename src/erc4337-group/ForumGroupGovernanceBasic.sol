...
abstract contract ForumGroupGovernanceBasic {
    ...
    function balanceOfBatch(bytes32[] memory owners, uint256[] memory ids)
        public
        view
        virtual
    ...
    function _batchMint(bytes32 to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) internal {
