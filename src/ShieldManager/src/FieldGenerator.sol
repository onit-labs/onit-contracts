...
contract FieldGenerator is Owned, IFieldGenerator {
	...
	constructor(address deployer, FieldSVGs memory svgs) Owned(deployer) {
	...
	function addColors(uint24[] memory __colors, string[] memory titles) external onlyOwner {
