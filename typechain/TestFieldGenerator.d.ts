...
interface TestFieldGeneratorInterface extends ethers.utils.Interface {
  functions: {
...
export class TestFieldGenerator extends BaseContract {
  ...
  interface: TestFieldGeneratorInterface;
