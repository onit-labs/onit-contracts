...
interface IForumGroupFactoryV2Interface extends ethers.utils.Interface {
  functions: {
...
export class IForumGroupFactoryV2 extends BaseContract {
  ...
  interface: IForumGroupFactoryV2Interface;
