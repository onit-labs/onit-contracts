...
interface EmblemWeaverTestInterface extends ethers.utils.Interface {
  functions: {
    "fieldGenerator()": FunctionFragment;
    "frameGenerator()": FunctionFragment;
    "generateSVGTest((uint16,uint16[9],uint16,uint24[4],bytes32,bytes32))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "generateSVGTest",
    values: [
      {
        field: BigNumberish;
        hardware: [
...
export class EmblemWeaverTest extends BaseContract {
  ...
  interface: EmblemWeaverTestInterface;
