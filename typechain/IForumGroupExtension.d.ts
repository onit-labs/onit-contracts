...
interface IForumGroupExtensionInterface extends ethers.utils.Interface {
  functions: {
...
export class IForumGroupExtension extends BaseContract {
  ...
  interface: IForumGroupExtensionInterface;
