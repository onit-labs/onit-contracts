...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
	...
	const deterministicDeployment = await deterministic('PfpStaker_v2', {
		contract: 'PfpStaker_v2',
		from: deployer,
...
export default func;
func.id = 'deploy_PFP_Staker_v2'; // id required to prevent reexecution
func.tags = ['PfpStaker_v2', 'Extensions', 'Forum'];
